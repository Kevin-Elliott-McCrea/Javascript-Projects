...
function determineAvatar() {
    // determind the correct avatar to paint for the active player
...
// this function changes active play over to the other player
...
function recordMoves(square) {
    ...
    var info = boardState.split(','); // call function to check if proposed square is already occupied
    return verdict;
}
...
function checkWinCon1(info,squareArray) {
    ...
    winner(winDetected,winDetected,winCon1); // winCon1 is the array of win combo
}
