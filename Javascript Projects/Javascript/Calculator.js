...
function Input_Decimal(dot) {
    ...
    // we are saying the if the Display_Value does not contain a decimal point
...
keys.addEventListener('click', (event) => {     //------------------- CHECKKKKKKKKKKKKKKKKKKKKKKKKKKK THE PARENTHESES
